package com.example.ticketing.captcha.application;

import com.example.ticketing.captcha.CaptchaService;
...
public class CaptchaController {
    ...
    @GetMapping
    public ResponseEntity<CaptchaResultStatistic> getStatistic(@Auth ClientInfo clientInfo) {
        CaptchaResultStatistic response = captchaService.getStatistic(clientInfo);
