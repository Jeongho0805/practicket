...
public enum ErrorCode {
    ...
    TICKET_TOKEN_EXPIRED(400, "T06", "예매 가능 시간이 만료되었습니다."),
    ...
    SERVICE_UNAVAILABLE(503, "S02", "요청 처리가 지연되고 있습니다. 잠시 후 다시 시도해주세요."),
    ...
    POST_RATE_LIMIT_TOKEN(429, "PO08", "글은 30초에 한 번만 쓸 수 있습니다. 잠시 후 다시 시도해주세요."),
